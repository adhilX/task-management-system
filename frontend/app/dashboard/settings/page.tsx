...
export default function EmployeeSettingsPage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-text-title">Settings</h1>
        <p className="text-xs text-text-muted mt-1">Manage your account security and credentials.</p>
      </div>
            ...
            <div>
              ...
              <div className="relative flex items-center bg-bg-input border border-border-input focus-within:border-brand-primary rounded-xl px-3.5 py-2.5 transition-colors">
                ...
                <button
                  ...
                  className="absolute right-3.5 top-1/2 -translate-y-1/2 text-text-muted hover:text-text-body focus:outline-none"
                >
